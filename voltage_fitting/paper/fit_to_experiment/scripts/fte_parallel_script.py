# Script to run a single_compartment training to data with 4 spikes, parallelized, using 2 neural networks
...
def simulation_loss_fn(all_params):
        loss = loss_fn(all_params, all_setup, t_max, i_amp, u_init, v_data, added_curr_std, nospike_u_time_constant, spike_u_time_constant, thr, dtw_reg = 1.0, spike_reg = 100.0, sse_reg = 0.0, add_reg = 0.0)
        return loss
...
plt.savefig("best_model_prediction.png", dpi=300, bbox_inches='tight')
