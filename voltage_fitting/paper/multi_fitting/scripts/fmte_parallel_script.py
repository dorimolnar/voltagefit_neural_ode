...
# Fine-tuning, using 2 neural networks
...
with open("best_models.eqx", "wb") as f:
...
fig.savefig("best_model_details.png", dpi=300, bbox_inches='tight')
...
fig.savefig("fine_tuned_top_10_results.png", dpi=300, bbox_inches='tight')
...
ax.set_ylabel("Voltage (mV)")
ax.legend(["Target", "Prediction"])
fig.savefig("fine_tuned_best_model_prediction.png", dpi=300, bbox_inches='tight')
...
fig.savefig("fine_tuned_best_model_details.png", dpi=300, bbox_inches='tight')
