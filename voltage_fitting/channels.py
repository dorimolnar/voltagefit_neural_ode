...
# class newNaTs2T(Channel):
#     """Added vt"""

#     def __init__(self, name: Optional[str] = None, gating_params=None):
#         self.current_is_in_mA_per_cm2=True
  
#         super().__init__(name)
#         prefix = self._name

#         self.x_vals = jnp.linspace(-100, 50, 10)
...
#         }
#         self.gating_params = {
#             "m_alpha_params": gating_params[0:10] if gating_params is not None else None,
#             "m_beta_params": gating_params[10:20] if gating_params is not None else None,
#             "h_alpha_params": gating_params[20:30] if gating_params is not None else None,
#             "h_beta_params": gating_params[30:40] if gating_params is not None else None,
#         }
#         self.channel_states = {
#             f"{prefix}_m": 0.1,  # Initial value for m gating variable
#             f"{prefix}_h": 0.1,  # Initial value for h gating variable
...
#         prefix = self._name
#         ms, hs = u[f"{prefix}_m"], u[f"{prefix}_h"]
#         m_new = solve_inf_gate_exponential(ms, dt, *self.m_gate(voltages, params["vt"], self.x_vals, self.gating_params['m_alpha_params'], self.gating_params['m_beta_params']))
#         h_new = solve_inf_gate_exponential(hs, dt, *self.h_gate(voltages, params["vt"], self.x_vals, self.gating_params['h_alpha_params'], self.gating_params['h_beta_params']))
#         return {f"{prefix}_m": m_new, f"{prefix}_h": h_new}
...
#         """Initialize the state at fixed point of gate dynamics."""
#         prefix = self._name
#         m_inf, _ = self.m_gate(v, params["vt"], self.x_vals, self.gating_params['m_alpha_params'], self.gating_params['m_beta_params'])
#         h_inf, _ = self.h_gate(v, params["vt"], self.x_vals, self.gating_params['h_alpha_params'], self.gating_params['h_beta_params'])
#         return {
#             f"{prefix}_m": m_inf,
#             f"{prefix}_h": h_inf,
#         }
...
#     #@staticmethod
#     def m_gate(self, v, vt, x_vals = None, m_alpha_params = None, m_beta_params = None):
#         """Voltage-dependent dynamics for the m gating variable."""
...
#     #@staticmethod
#     def h_gate(self, v, vt, x_vals = None, h_alpha_params = None, h_beta_params = None):
#         """Voltage-dependent dynamics for the h gating variable."""
...
#         super().__init__(name)
#         prefix = self._name
#         self.x_vals = jnp.linspace(1e-7, 0.005, 10)
#         self.channel_params = {
...
#         }
#         self.gating_params = {
#             "z_gate_params": gating_params if gating_params is not None else None,
#         }
#         self.current_name = f"i_K"
#         self.META = {
...
#         z_new = solve_inf_gate_exponential(zs, dt, *self.z_gate(cai, self.x_vals, self.gating_params['z_gate_params']))
...
#         z_inf, _ = self.z_gate(cai, self.x_vals, self.gating_params['z_gate_params'])
#         return {f"{prefix}_z": z_inf}

#     #@staticmethod
#     def z_gate(self, cai, x_vals = None, z_gate_params = None):
...
#         prefix = self._name
#         ms = u[f"{prefix}_m"]
#         m_new = solve_inf_gate_exponential(ms, dt, *self.m_gate(voltages, self.x_vals, self.gating_params['m_alpha_params'], self.gating_params['m_beta_params']))
...
#         """Initialize the state at fixed point of gate dynamics."""
#         prefix = self._name
#         m_inf, _ = self.m_gate(v, self.x_vals, self.gating_params['m_alpha_params'], self.gating_params['m_beta_params'])
#         return {f"{prefix}_m": m_inf}

#     #@staticmethod
#     def m_gate(self, v, x_vals = None, m_alpha_params = None, m_beta_params = None):
#         """Voltage-dependent dynamics for the m gating variable."""
#         modified = m_alpha_params != None
#         if x_vals is None:
#             x_vals = jnp.linspace(-100, 50, 10)
...
#         if(modified):
#             m_inf += interpolate_params(v, x_vals, m_alpha_params)
#             tau_m += interpolate_params(v, x_vals, m_beta_params)
#         return m_inf, tau_m
